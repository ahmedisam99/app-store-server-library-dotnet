...
public class AppStoreServerAPIClientTests
{
        ...
        string? resourcePath, HttpStatusCode statusCode)
    {
        ...
        var client = new AppStoreServerAPIClient(signingKey, KeyId, IssuerId, BundleId, Environment.LocalTesting,
            httpClient);
    ...
    private static void AssertCommonHeaders(TestHttpMessageHandler handler)
    {
        ...
        Assert.Contains("enjna-app-store-server-library/dotnet/1.0.0", request.Headers.GetValues("User-Agent"));
    ...
    public void XcodeEnvironment_ThrowsArgumentException()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            new AppStoreServerAPIClient(signingKey, KeyId, IssuerId, BundleId, Environment.Xcode));
    }
