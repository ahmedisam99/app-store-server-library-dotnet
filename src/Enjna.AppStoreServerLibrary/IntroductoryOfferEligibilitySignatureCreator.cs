...
public class IntroductoryOfferEligibilitySignatureCreator : JWSSignatureCreator
{
    ...
    public IntroductoryOfferEligibilitySignatureCreator(string signingKey, string keyId, string issuerId)
        : base("introductory-offer-eligibility", signingKey, keyId, issuerId)
    {
    }
    ...
    public string CreateSignature(string productId, bool allowIntroductoryOffer, string transactionId, string bundleId)
    {
